                    ...
                    <div id="main">
                        ...
                        <section className="container-fluid">
                            ...
                            <div className="col-12 headings">
                                ...
                                <div layout="row" flex>
                                    <md-input-container flex className="md-icon-float md-block md-title">
                                    <label>Enter Payment Address</label>
                                    {/* below is the material icons */}
                                    <md-icon className="material-icons">account_balance_wallet</md-icon>
                                    <input type="text" ng-model="paymentAddress" />
                                    </md-input-container>
                                    <div>
                                    <md-button className="md-raised md-primary" ng-click="addAddress()">
